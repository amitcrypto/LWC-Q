...
namespace cs
{
    class Driver
    {
        static void Main(string[] args)
        {
            ...
            Estimates.KeySchedule<QGIFT.InPlace.KeySchedule>("in_place = true - round = 40", 40, free_swaps); 
            Estimates.AddConstants<QGIFT.InPlace.AddConstants>("widest = true - state size is the same for all", 40, free_swaps); 
            ...
            Estimates.Gift<QGIFT.Gift>("in_place", 40, free_swaps, "_128_in-place"); 

            Estimates.GroverOracle<QGIFT.GroverOracle>("in_place mixcolumn - r = 1", 1, 40, free_swaps, "_128_in-place-MC_r1");
            Estimates.GroverOracle<QGIFT.GroverOracle>("in_place mixcolumn - r = 2", 2, 40, free_swaps, "_128_in-place-MC_r2");
            Estimates.GroverOracle<QGIFT.GroverOracle>("in_place mixcolumn - r = 3", 3, 40, free_swaps, "_128_in-place-MC_r3"); 
