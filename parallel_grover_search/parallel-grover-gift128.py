...
def GroverDWCost(cipher, GDs, Ws, Gs, key_pc, ps, spurious_key_threshold=2**(-20), caption="", ignore_r=False, gift=False):
    """
        ...
        for lMD in logMDs:
            ...
            for i in range(len(key_pc)):
                ...
                for r in range(1, pairs+1):
                    ...
                    skp = spurious_keys_probability(lk, 128 if not gift else lk, r, S)
